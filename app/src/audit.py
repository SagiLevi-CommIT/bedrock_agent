...
Each log line is a single-line JSON object so CloudWatch Logs Insights can
filter on individual fields. Logger names mirror vcomm: `agent.audit`,
`agent.cost`, `agent.tool_trace`, `agent.bedrock`.
"""
